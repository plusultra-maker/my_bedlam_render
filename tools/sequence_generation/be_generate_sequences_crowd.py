...
SMPLX_NPZ_ANIMATION_FOLDER = Path("/mnt/e/CS/Graphics/bedlam_render/animations/gendered_ground_truth_test")
...
TEXTURES_CLOTHING_PATH = Path("../../config/textures_clothing_test.csv") # List of available clothing textures per subject
