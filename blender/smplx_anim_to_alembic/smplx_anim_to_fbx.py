...
#
# Convert SMPL-X animation in .npz format to FBX .fbx
#
# Notes:
...
def convert_to_fbx(smplx_animation_path, output_path):
    ...
    bpy.ops.object.smplx_export_fbx(filepath=str(output_path))
    return True
...
if __name__== "__main__":
    ...
    if bpy.app.background:
        if "--" in sys.argv:
            ...
            parser = argparse.ArgumentParser(description="Convert SMPL-X animation in .npz format to FBX .fbx")
