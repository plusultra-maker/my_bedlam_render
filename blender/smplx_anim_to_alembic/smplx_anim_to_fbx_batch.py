...
#
# Batch convert SMPL-X .npz animations to .fbx
#
# Requirements: Blender with SMPL-X Blender add-on (20220311 or later)
#
# Notes:
# + Python for Windows: py -3 smplx_anim_to_fbx_batch \path\to\input\dir \path\to\output\dir
#
...
if __name__ == "__main__":
    ...
    for input_path in filenames:
        ...
        output_path = output_dir / body_name / f"{body_name}_{body_name_suffix}.fbx"
...
# python smplx_anim_to_fbx_batch.py E:\CS\Graphics\bedlam_render\animations\gendered_ground_truth_test E:\CS\Graphics\bedlam_render\fbx 6
